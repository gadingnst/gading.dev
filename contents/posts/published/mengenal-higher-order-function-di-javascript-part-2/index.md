...
Contoh saja untuk sorting, sebenarnya algoritma sorting banyak, mulai dari *bubble*, *quick*, *insertion*, *selection* dsb. Dan btw, aku tidak menjamin dengan menggunakan ***higher-order function*** ini kita mendapatkan *best performance*, tapi yang kita lihat disini bukan tingkat performanya, melainkan tingkat praktisnya atau biasa disebut *best practice*. Bisa dilihat, kode yang kita tulis dari awal sampai akhir tadi tidak ada yang panjang dan bertele-tele, semuanya singkat serta mudah dibaca dan dijelaskan.
