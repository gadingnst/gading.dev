...
Jadi, **dibanding berpikir bahwa program kita adalah kumpulan objek yang berkomunikasi dan bergantungan satu sama lain, lebih baik berpikir bahwa program kita adalah kumpulan fungsi kecil yang beroperasi dengan datanya masing-masing secara independen.** Apalagi sekarang sedang *trend*-nya *Microservice*. Contoh sederhanya seperti: *AWS lambda function*, *Google Cloud function*, *Firebase function* dan sebagainya. Secara *flow*, sebenarnya arsitektur *microservice* itu sama persis dengan alur paradigma fungsional. Karena pada *microservice*, *service-service* yang dibangun bersifat *independent* dan tidak bergantung dengan *service* yang lain.
