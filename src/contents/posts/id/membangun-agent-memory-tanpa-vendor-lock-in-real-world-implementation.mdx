...
3. **Decayed Traversal**: Saat melakukan pencarian semantik (RAG), query engine kita akan melakukan *1-hop expansion* ke tanggal yang terdaftar di `related_dates` dengan memotong skor semantiknya sebesar 30% (`score * 0.7`) sebagai penanda bahwa itu adalah informasi sekunder/konteks pendukung.
