...
date: 2026-07-19
description: "Bagian ketiga dari seri memori agen. Kali ini kita bedah implementasi riil: membuang AnythingLLM untuk memangkas resource, beralih ke FastMCP terpadu, dan merancang Dual-Lane Memory (RAG + SQL Analytics)."
...
Tapi pas masuk ke fase implementasi riil di homelab, gw langsung nabrak kenyataan pahit: **AnythingLLM yang gw pake sebagai RAG interface ternyata boros resource dan kegedean buat kebutuhan personal.** 
...
File-file transkrip mentah ini sengaja ditaruh di lokal dulu (grace period H-2) sebelum nantinya di-ingest, dibuat summary-nya, di-index secara semantik, dan diarsipkan secara permanen ke NAS oleh pipeline sinkronisasi otomatis harian.
...
Kenapa Postgres? Karena pada akhirnya, semua jalan ninja arsitektur homelab kita bakal berujung pada satu kesimpulan mutlak: **Just Use Postgres.**
