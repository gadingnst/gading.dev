...
![Peta Topologi Arsitektur Homelab](/media/blog/homelab-architecture-k8s-lxc-proxmox/topology.svg)
...
2. **Database Provisioning**
   Backend menghubungi `db-host` secara terprogram untuk membuat database dan user terisolasi khusus untuk client tersebut:
