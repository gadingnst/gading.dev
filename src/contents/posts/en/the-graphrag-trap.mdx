...
In my previous post, [Building GraphRAG for Autonomous Agents with Neo4J and Graphitti](/blog/building-graphrag-neo4j-graphitti), I shared how I went all-in on setting up **Neo4j**, integrating **Graphitti**, and building a complex extraction pipeline for **Nouva**, my personal AI assistant. 
