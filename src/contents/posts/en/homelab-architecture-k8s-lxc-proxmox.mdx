...
![Homelab Architecture Topology Map](/media/blog/homelab-architecture-k8s-lxc-proxmox/topology.svg)
...
2. **Database Provisioning**
   The backend contacts the `db-host` programmatically to create an isolated database and database user for the client:
