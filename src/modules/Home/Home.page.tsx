    ...
    <div className={styles.container}>
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          Visit the demo API{' '}
          <UnstyledLink href="/api/jokes">
            <code className={styles.code}>/api/jokes</code>
          </UnstyledLink>
        </p>

        <ButtonLink className="bg-fuchsia-400 hover:bg-fuchsia-500 mt-5" href="/about?text=Hello%20World">
          About Page
        </ButtonLink>

        <hr className="w-full max-w-lg my-8" />

        <ButtonLink className="bg-blue-500 hover:bg-blue-700 mb-8 text-center" href="https://github.com/gadingnst/fullstack-next-template/generate">
          Use this Template
        </ButtonLink>
