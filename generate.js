...
const generatePostList = async () => {
  ...
  Promise.all((await fs.readdir(publishedPath, 'utf-8')).map(async res => ({
    ...
    .then(async result => {
      ...
      const strResult = `/* eslint-disable */\n// THIS IS AN AUTOGENERATED FILE.\n// DON'T EDIT THIS FILE DIRECTLY.\n\nexport default ${JSON.stringify(result)}`
      fs.writeFile(path.resolve(publishedPath, 'index.js'), strResult)
